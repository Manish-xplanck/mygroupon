...
CREATE TABLE `{prefix}system_log` (
  ...
  `username` char(15) NOT NULL default 'сн©м',
...
CREATE TABLE `{prefix}tttuangou_payment` (
  ...
  `name` varchar(120) NOT NULL,
  `detail` text NOT NULL,
  `order` int(1) unsigned NOT NULL default '0',
...
CREATE TABLE `{prefix}tttuangou_product` (
  ...
  `type` enum('ticket','stuff') NOT NULL default 'ticket',
...
CREATE TABLE `{prefix}tttuangou_push_template` (
  ...
  `intro` varchar(256) character set utf8 NOT NULL,
