...
团购券编号：{number}
密码：{password}',
        'sms' => '感谢您的购买，您的团购券编号：{number}，密码：{password}，请尽快使用，以免过期！',
      ),
      'cfg' => 
      array (
        'mail' => 
    ...
    array (
      ...
      'msg' => 
      array (
        'mail' => '您购买的“{productflag}”的订单已经完成！（编号：{orderid}），感谢您的购买！',
      ),
      'cfg' => 
      array (
        'mail' => 
    ...
    array (
      ...
      'msg' => 
      array (
        'sms' => '您好，您购买的商品已经发货，送货方式：{name}，运单号：{invoice}',
        'mail' => '您好，您购买的商品已经发货，送货方式：{name}，运单号：{invoice}',
      ),
      'cfg' => 
      array (
        'sms' => 
