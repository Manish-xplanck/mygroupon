        ...
        <div class="clear box">
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<?php $index=0;; ?>
					<!-- Alipay -->
						<div class="wholetip clear"><h3><?php echo ++$index; ?>、支付宝（仅支持即时到帐，如没有保留为空）</h3></div>
                        <div class="field">
                            <label>商户ID号</label>
                            <input type="text" size="30" name="alipay[mid]" class="f-input" style="width:200px;" value="<?php echo $INI['alipay']['mid']; ?>"/><span class="inputtip">商户申请：<a href="http://www.zuitu.com/value_alipay.html">签约支付宝</a></span>
                        </div>
                        <div class="field">
                            <label>交易密钥</label>
                        ...
                        <div class="field">
                            <label>交易类型</label>
							<select name="alipay[guarantee]" class="f-input" style="width:160px;"><?php echo Utility::Option($option_guarantee, $INI['alipay']['guarantee']); ?></select><span class="inputtip">支付宝担保交易／即时到帐交易</span>
						</div>
                        <div class="field">
                            <label>成交条件</label>
							<select name="alipay[guaranteesuccess]" class="f-input" style="width:160px;"><?php echo Utility::Option($option_guaranteesuccess, $INI['alipay']['guaranteesuccess']); ?></select><span class="inputtip">买家付款到支付宝／支付宝成功放款</span>
						</div>
						<div class="field">
                            <label>快捷登陆</label>
							<select name="alipay[alifast]" class="f-input" style="width:160px;"><?php echo Utility::Option($option_alifast, $INI['alipay']['alifast']); ?></select><span class="inputtip">使用支付宝大快捷登陆</span>
						</div>
						<div class="field">
                            <label>物流地址</label>
							<select name="alipay[aliaddress]" class="f-input" style="width:160px;"><?php echo Utility::Option($option_aliaddress, $INI['alipay']['aliaddress']); ?></select><span class="inputtip">使用支付宝物流地址 / 关闭支付宝物流地址 (大快捷登陆用户)</span>
						</div>
					<!-- Alipay/End -->
