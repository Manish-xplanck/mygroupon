...
class ModuleObject extends MasterObject
{
	...
	$this->Title = '提示';
		...
		$onlineip=$_SERVER['REMOTE_ADDR'];
				$email_message="您好：<br/>
这封信是由 {$this->Config['site_name']} 发送的。<br/>
您收到这封邮件，是因为在{$this->Config['site_name']}上这个邮箱地址被登记为用户邮箱，且该用户请求使用 Email 密码重置功能所致。<br/>
----------------------------------------------------------------------<br/>
重要！<br/>
----------------------------------------------------------------------<br/>
如果您没有提交密码重置的请求或不是{$this->Config['site_name']}的注册用户，请立即忽略并删除这封邮件。只在您确认需要重置密码的情况下，才继续阅读下面的内容。<br/>
----------------------------------------------------------------------<br/>
密码重置说明<br/>
----------------------------------------------------------------------<br/>
...
<br/>
上面的页面打开后，输入新的密码后提交，之后您即可使用新的密码登录{$this->Config['site_name']}了。您可以在个人设置中随时修改您的密码。<br/>
<br/>
本请求提交者的 IP 为 $onlineip<br/>
此致<br/><br/>
{$this->Config['site_name']} 管理团队.<br/>
